package org.mcphoton.mc.protocol.data;
...
import org.mcphoton.mc.protocol.data.game.BossBarAction;
import org.mcphoton.mc.protocol.data.game.BossBarColor;
import org.mcphoton.mc.protocol.data.game.BossBarDivision;
import org.mcphoton.mc.protocol.data.game.ClientRequest;
import org.mcphoton.mc.protocol.data.game.MessageType;
import org.mcphoton.mc.protocol.data.game.PlayerListEntryAction;
import org.mcphoton.mc.protocol.data.game.ResourcePackStatus;
import org.mcphoton.mc.protocol.data.game.TitleAction;
import org.mcphoton.mc.protocol.data.game.entity.Effect;
import org.mcphoton.mc.protocol.data.game.entity.EntityStatus;
import org.mcphoton.mc.protocol.data.game.entity.EquipmentSlot;
import org.mcphoton.mc.protocol.data.game.entity.attribute.AttributeType;
import org.mcphoton.mc.protocol.data.game.entity.attribute.ModifierOperation;
import org.mcphoton.mc.protocol.data.game.entity.attribute.ModifierType;
import org.mcphoton.mc.protocol.data.game.entity.metadata.MetadataType;
...
import org.mcphoton.mc.protocol.data.game.entity.player.CombatState;
...
import org.mcphoton.mc.protocol.data.game.entity.player.InteractAction;
...
import org.mcphoton.mc.protocol.data.game.entity.player.PositionElement;
import org.mcphoton.mc.protocol.data.game.entity.type.GlobalEntityType;
import org.mcphoton.mc.protocol.data.game.entity.type.MobType;
import org.mcphoton.mc.protocol.data.game.entity.type.PaintingType;
import org.mcphoton.mc.protocol.data.game.entity.type.object.HangingDirection;
import org.mcphoton.mc.protocol.data.game.entity.type.object.MinecartType;
import org.mcphoton.mc.protocol.data.game.entity.type.object.ObjectType;
import org.mcphoton.mc.protocol.data.game.scoreboard.CollisionRule;
import org.mcphoton.mc.protocol.data.game.scoreboard.NameTagVisibility;
...
import org.mcphoton.mc.protocol.data.game.scoreboard.ScoreboardAction;
import org.mcphoton.mc.protocol.data.game.scoreboard.ScoreboardPosition;
import org.mcphoton.mc.protocol.data.game.scoreboard.TeamAction;
import org.mcphoton.mc.protocol.data.game.scoreboard.TeamColor;
import org.mcphoton.mc.protocol.data.game.setting.ChatVisibility;
import org.mcphoton.mc.protocol.data.game.setting.Difficulty;
import org.mcphoton.mc.protocol.data.game.statistic.Achievement;
import org.mcphoton.mc.protocol.data.game.statistic.GenericStatistic;
import org.mcphoton.mc.protocol.data.game.window.ClickItemParam;
import org.mcphoton.mc.protocol.data.game.window.CreativeGrabParam;
import org.mcphoton.mc.protocol.data.game.window.DropItemParam;
import org.mcphoton.mc.protocol.data.game.window.FillStackParam;
import org.mcphoton.mc.protocol.data.game.window.MoveToHotbarParam;
import org.mcphoton.mc.protocol.data.game.window.ShiftClickItemParam;
import org.mcphoton.mc.protocol.data.game.window.SpreadItemParam;
import org.mcphoton.mc.protocol.data.game.window.WindowAction;
import org.mcphoton.mc.protocol.data.game.window.WindowType;
import org.mcphoton.mc.protocol.data.game.window.property.AnvilProperty;
import org.mcphoton.mc.protocol.data.game.window.property.BrewingStandProperty;
import org.mcphoton.mc.protocol.data.game.window.property.EnchantmentTableProperty;
import org.mcphoton.mc.protocol.data.game.window.property.FurnaceProperty;
import org.mcphoton.mc.protocol.data.game.world.Particle;
import org.mcphoton.mc.protocol.data.game.world.WorldBorderAction;
import org.mcphoton.mc.protocol.data.game.world.WorldType;
import org.mcphoton.mc.protocol.data.game.world.block.BlockFace;
import org.mcphoton.mc.protocol.data.game.world.block.UpdatedTileType;
import org.mcphoton.mc.protocol.data.game.world.block.value.ChestValueType;
import org.mcphoton.mc.protocol.data.game.world.block.value.GenericBlockValueType;
import org.mcphoton.mc.protocol.data.game.world.block.value.MobSpawnerValueType;
import org.mcphoton.mc.protocol.data.game.world.block.value.NoteBlockValueType;
import org.mcphoton.mc.protocol.data.game.world.block.value.PistonValue;
import org.mcphoton.mc.protocol.data.game.world.block.value.PistonValueType;
import org.mcphoton.mc.protocol.data.game.world.effect.ParticleEffect;
import org.mcphoton.mc.protocol.data.game.world.effect.SmokeEffectData;
import org.mcphoton.mc.protocol.data.game.world.effect.SoundEffect;
import org.mcphoton.mc.protocol.data.game.world.notify.ClientNotification;
import org.mcphoton.mc.protocol.data.game.world.notify.DemoMessageValue;
import org.mcphoton.mc.protocol.data.game.world.notify.EnterCreditsValue;
import org.mcphoton.mc.protocol.data.game.world.sound.BuiltinSound;
import org.mcphoton.mc.protocol.data.game.world.sound.SoundCategory;

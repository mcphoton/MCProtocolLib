 ...
 */
public class DisconnectingEvent extends SessionEvent {
	 ...
	 *
	 * @return The Throwable responsible for the disconnect, or null if the disconnect was not
	 *         caused by a Throwable.
	 */

 ...
 */
public class PacketReceivedEvent extends SessionEvent {
	...
	public <T extends Packet> T getPacket() {
		try {
			...
			throw new IllegalStateException("Tried to get packet as the wrong type. Actual type: "
					+ this.packet.getClass().getName());
		}
	}
